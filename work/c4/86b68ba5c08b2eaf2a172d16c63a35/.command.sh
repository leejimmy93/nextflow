...
locus = sumstats.filter_value('CHR==7 & POS>133868632 & POS<134868632')
...
# Save locus data
locus.data.to_csv("locus_7_134368632.tsv", sep="\t", index=False)

# Save SNP list for LD calculation
locus.data["SNPID"].to_csv("locus_7_134368632.snplist",
